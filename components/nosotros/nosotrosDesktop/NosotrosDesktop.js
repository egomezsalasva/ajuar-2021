...
export default function NosotrosDesktop() {
  return (
    <>
      <Container>
        <TextNosotros>
          Somos un equipo creativo multidisciplinar formado por{" "}
          <TextoImagen bgImg="url(./assets/jorge.jpg)" portraitImg={true}>
            Jorge Vidal
          </TextoImagen>
          , fotógrafo,{" "}
          <TextoImagen bgImg="url(./assets/joan.jpg)" portraitImg={true}>
            Joan Hurtado
          </TextoImagen>
          , diseñador gráfico e ilustrador, y{" "}
          <TextoImagen bgImg="url(./assets/nerea.jpg)" portraitImg={true}>
            Nerea Moreno
          </TextoImagen>
          ...
          <TextoImagen bgImg="url(./assets/nuestrosTrabajos.gif)">
            nuestros trabajos
          </TextoImagen>
          ...
          <TextoImagen bgImg="url(./assets/cafe.jpg)">café</TextoImagen> (
          <TextoImagen bgImg="url(./assets/lemonade.jpg)">limonada</TextoImagen>
          ,{" "}
          <TextoImagen bgImg="url(./assets/bitterKas.jpg)">
            bitter kas
          </TextoImagen>
          , <TextoImagen bgImg="url(./assets/chai.jpg)">chai latte</TextoImagen>
