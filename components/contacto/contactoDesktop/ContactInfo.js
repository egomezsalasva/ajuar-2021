  ...
  return (
    <>
      <ContactInfoContainer>
        ...
        <a
          href="https://api.whatsapp.com/send?phone=+34607707361"
          target="_blank"
        >
          (+34) 607 707 361
        </a>
        <div className="email" onClick={copyCodeToClipboard}>
          {email} <span className="clipboardButton">{copySuccess}</span>
        </div>
